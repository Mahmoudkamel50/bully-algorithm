...
public class BullyNodeImpl2 extends UnicastRemoteObject implements BullyNode {
    private static final long serialVersionUID = 1L;
    private int id;
    private int coordinatorId;
    private Map<Integer, BullyNode> nodes;
    private boolean isCoordinator;
    static BullyNode stub2;
    ...
    protected BullyNodeImpl2() throws RemoteException {
    }
    ...
    public static void main(String[] args) throws RemoteException {
        BullyNodeImpl2 node = new BullyNodeImpl2();
        try {
            stub2 = (BullyNode) UnicastRemoteObject.exportObject(node, 0);
            Registry registry= LocateRegistry.getRegistry();
            registry.bind("stub2", stub2);

            System.err.println("Node stub2 is ready");
            stub2.startElection();
