...
public class BullyNodeImpl3 extends UnicastRemoteObject implements BullyNode {
    private static final long serialVersionUID = 1L;
    private int id;
    private int coordinatorId;
    private Map<Integer, BullyNode> nodes;
    private boolean isCoordinator;
    static BullyNode stub3;
    ...
    protected BullyNodeImpl3() throws RemoteException {
    }
    ...
    public static void main(String[] args) throws RemoteException {
        ...
        try {
            stub3 = (BullyNode) UnicastRemoteObject.exportObject(node, 0);
            Registry registry= LocateRegistry.getRegistry();
            registry.bind("stub3", stub3);

            System.err.println("Node stub3 is ready");
            stub3.startElection();
